...
//        self.sendRequestToServer(methodId: 8,request: ["animal":self.animalName]){ (result) in
//            if result != nil{
//                print(result)
...
//                            for facts in json.arrayValue {
//                                let fact = facts["facts"].stringValue.replacingOccurrences(of: "\\n", with: "\n")
//                                DispatchQueue.main.async {
//                                    self.descriptionTextBox.text = fact
//                                }
//                            }
//                        }
//                    }
