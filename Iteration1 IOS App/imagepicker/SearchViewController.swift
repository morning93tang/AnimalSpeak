...
class SearchViewController: UIViewController {
    ...
    func configureSearchController() {
        ...
        searchController.searchBar.scopeButtonTitles = ["All", "Mammal", "Birds"]
        ...
        if cell!.isSelected
        {
            ...
            if cell!.accessoryType == UITableViewCell.AccessoryType.none
            {
                if self.searchController.isActive{
                    if let index = selctedanimalList.index(of:self.filteredAnimalList[indexPath.row]) {
...
extension SearchViewController : UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        if let index = selctedanimalList.index(of:ani){
                cell.accessoryType = UITableViewCell.AccessoryType.checkmark
            }else{
                cell.accessoryType = UITableViewCell.AccessoryType.none
            }
//        //cell.imageView!.image = ani.image
////        if cell.isSelected
////        {
////            cell.isSelected = false
//            if cell.accessoryType == UITableViewCell.AccessoryType.none
